          ...
          <div className="rounded-[2rem] border border-zinc-200 bg-white shadow-xl p-10">
            <div className="grid grid-cols-2 gap-5">
              <div className="rounded-3xl bg-zinc-900 text-white p-6">
                ...
                <h3 className="mt-3 text-4xl font-black">2026+</h3>
              </div>

              <div className="rounded-3xl bg-zinc-100 p-6">
                <p className="text-sm text-zinc-500">Brand Standard</p>
                <h3 className="mt-3 text-4xl font-black text-zinc-900">
                  Premium
                </h3>
              </div>

              <div className="col-span-2 rounded-3xl border border-zinc-200 p-8 bg-white">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-zinc-100 flex items-center justify-center mx-auto text-xl">
                  ✦
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="rounded-[2rem] bg-white border border-zinc-200 p-10 shadow-sm"
              >
                <p className="text-zinc-400 font-bold text-sm tracking-[0.2em]">
                  {item.step}
                </p>
